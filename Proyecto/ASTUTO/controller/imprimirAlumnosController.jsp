...
<%
  try{
   ...
   PdfWriter.getInstance(documento,new FileOutputStream("C:/informeAlumnos.pdf"));
   ...
   Paragraph pg = new Paragraph ("Informe Alumnos");
   ...
   //Cerrar documento
   documento.close();
   messageBean.setMsg("Se ha creado un documento en PDF en la siguiente dirección: C:/informeAlumnos.pdf");
   messageBean.setUrl("../controller/principalAdministradorController.jsp");
