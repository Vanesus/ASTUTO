   ...
   if(correo==("") && profesor==("") && asignatura==("") ){
	...
	//Introducimos datos de busqueda
		...
		if(resultado.size()!=0){
		 ...
		 //Redirecciono a la vista que muestra la pagina.	  
		 %>
           <jsp:forward page="../view/alumnoMantView.jsp"/>
         <%
