...
if (loginBean.getUser()==""){
 ...
 if(idPetTut==null ){
  if (correo==null) { 
	...
	if(resultado.size()!=0){
		...
		if (profesor==null || asignatura==null ||profesor.equals("null") || asignatura.equals("null")){
		   profesor ="";
		   asignatura="";
		}
		...
		query = pm.getPropiedad("selectPeticionTut"); 
		micon = new ConexionBD();
		...
		if(resultadoPetTut.size()!=0){
			...
			%>
               <jsp:forward page="../view/peticionTutAlumnoView.jsp"/>
            <% 
		}	
	}
  }
 ...
 if(idPetTut!=null && opcion ==null){
		...
		//Redirecciono a la vista que muestra la pagina.	  
		%>
          <jsp:forward page="../view/informacionPeticionTutView.jsp"/>
        <% 
	}
