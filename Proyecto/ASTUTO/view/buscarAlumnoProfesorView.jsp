...
<table background= "../images/investigaAlum.gif" border="0" cellpadding="2" cellspacing="2" width="100%"><tbody><tr>
    <td class="T24" align="right"><font color="#ffffff">B&nbsp;u&nbsp;s&nbsp;c&nbsp;a&nbsp;r&nbsp; A&nbsp;l&nbsp;u&nbsp;m&nbsp;n&nbsp;o&nbsp;s&nbsp;</font></td>
      </tr></tbody></table>
</td></tr>
    <tr valign="top">
        <td>
          ...
          <tbody><tr valign="top">
            ...
            <%String login= request.getParameter("login");%>  
                    <table border="0" cellpadding="4" cellspacing="0" width="100%"> <tbody>
                        ...
                        <tr> 
                            <td colspan="3" class="T10a"> <form action="../controller/listadoAlumnosProfesorController.jsp?login=<%=login%>" method="post" name="busqueda" id="busqueda">
                            <table width="467" align="center">
                                <tr> 
                                  <td width="84" align="left"><font color="8c1229"><span class="T10L">Correo:</span></font></td>
                                  <td width="261"><input name="correo" type="text" class="CampoTexto" id="correo" style="font-size: 10pt; font-family: arial,helvetica; maxlength=" size="30" maxlength="20" /></td>
                                </tr>
                                <tr> 
                                  <td height="24" align="left"><font color="8c1229"><span class="T10L">Asignatura:</span></font></td>
