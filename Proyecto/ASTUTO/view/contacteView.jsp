...
<table background="../images/investigaAlum.gif" border="0" cellpadding="2" cellspacing="2" width="100%"><tbody><tr>
      <td class="T24" align="right"><font color="#ffffff"> C&nbsp;o&nbsp;n&nbsp;t&nbsp;a&nbsp;c&nbsp;t&nbsp;o&nbsp;</font></td>
        ...
        <tr valign="top">
           ...
           <td class="T10a"> 
            ...
            <table height="30" align="center" >
              <tr border="0" > 
                <td width="160" height="24" bordercolor="#FFFFFF" class="T10L" ><p><strong>Correo 
                    de contacto:</strong></p></td>
                <td width="220" class="T10L">astutouco@gmail.com</td>
              </tr>
            </table>
