...
<table background= "../images/investigaAlum.gif" border="0" cellpadding="2" cellspacing="2" width="100%"><tbody><tr>
      ...
      <tr valign="top">
	   <td>
          ...
          <tbody><tr valign="top">
        <td class="T10a"> <table width="523" border="0" cellpadding="4" cellspacing="0" style="width: 459px; height: 200px;">
            <tbody>
              <tr valign="top"> 
                <td width="515"> <table bgcolor="#d69e00" width="100%">
                    <tbody>
                      <tr> 
                  ...
                  <table border="0" cellspacing="2" cellpadding="2" width="461" align="center">
                    <tbody>
                      <tr> 
                        <td class="T10L" valign="top" width="20%"><span class="Estilo2">Correo:</span></td>
                        <td class="T10" valign="top" width="80%"><%=correo%></td>
                      </tr>
                      <tr> 
                        <td class="T10L" valign="top" width="20%"><span class="Estilo2">Asignatura:</span></td>
                  ...
                  <p>&nbsp; </p>
                  <table  width="336" height="56" align="center"	>
                    <tr valign="top"> 
                      <td width="133" height="23" class="T10" align="left"><strong><font color="#8c1229">Correo</font></strong></td>
                      <td width="187" class="T10" align="left"><strong><font color="#8c1229">Nombre</font></strong></td>
                    </tr>
                    <%String color ="#FFFDE5";%>
                    ...
                    <tr valign="top" bgcolor="<%=color%>"> 
                      <td width="133" height="25" class="T9L"><a class="T9L" href="../controller/peticionTutAlumnoProfesorController.jsp?correo=<%=alumnoBean.getCorreo(i)%>&correoBuscar=<%=correo%>&login=<%=login%>&asignatura=<%=asignatura%>">&nbsp;<%=alumnoBean.getCorreo(i)%></font></a></td>
                      <td class="T9L">&nbsp;<%=alumnoBean.getNombre(i)%></font></td>
                    </tr>
                    <%}%>
                  </table>
                  <p class="T8L" align="center">Puedes obtener información de las 
                    tutoría asignadas al alumno haciendo click en su correo.</p>
                  <table>
                    <tr> 
                      <td width="163"></td>
                      <td width="91"></td>
                      <td width="220" align="right"><a href="../controller/imprimirAlumnosProfesorController.jsp" rel="gb_page[450,400]"><img src="../images/imprimirPDF.gif" border="0"/></a><span class="T10"><font color="#8c1229">Descargar 
                        en PDF</font></span></td>
                    </tr>
                  </table>
                  <p>&nbsp;</p>
